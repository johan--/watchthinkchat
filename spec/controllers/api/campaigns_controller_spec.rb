...
#     create(:campaign, { campaign_type: 'youtube',
#                         video_id: '12345',
#                         password: 'password' }.merge(atts))
#   end
...
#                               'show_sub_orgs' => true,
#                               'status' => 'active',
#                               'created_at' => '2014-08-06T10:53:21-05:00',
#                               'updated_at' => '2014-08-06T10:53:21-05:00',
#                               'token' => 'mhtoken' })
...
#         ['Operator Link has already been taken'])
#     end
#   end
...
#       operator = create_operator
#       create_campaign(admin1: operator)
#       sign_in operator
...
#       post :create, new_params
#       expect(json_response['error']).to eq(
#         ['Name can\'t be blank', 'Operator Link can\'t be blank'])
#     end
...
#       put :update, new_params.merge(uid: campaign.uid)
#       expect(json_response['error']).to eq(
#         ['Followup button 1: Btn text can\'t be blank'])
#     end
...
#                                    '#FallingPlates and for considering '\
#                                    'Jesus\'s '\
...
#                                    'panel on the right :)   ----->',
#               message_no_chat: 'Thanks for taking time to watch '\
#                                '#FallingPlates '\
#                                'and for considering Jesus\'s call to follow '\
#                                'Him. To want to begin to start following '\
#                                'Jesus is a significant step. We have a growth '\
#                                'adventure that can help u grow after u have '\
#                                'asked Christ to come into your life. '\
#                                'Heres the place for '\
#                                'u to get connected with a friend to grow :)'
#             }
#           ]
#       }
...
#         post :password, uid: campaign.uid, password: 'password'
#         # should only increment UserOperator count by 1 still
#         expect(json_response['share_url']).to eq(share_url)
#       end).to change(UserOperator, :count).by(1)
#       assert_response 201
#     end
#   end
