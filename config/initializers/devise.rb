...
Devise.setup do |config|
  ...
  # config.pepper = "533949fe5d1f769da4c56d9759172531fb46753492aed77fa5d761b3940ee6bf50959c29f6235931ce634968abbd247fea10aa57fd6d55dfeb7d31dbf920834c"
  ...
  config.omniauth :facebook, "#{ENV["fb_app_id"]}", "#{ENV["fb_app_secret"]}", :provider_ignores_state => true
